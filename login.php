                    ...
                    <form action="login.php" method="post">
                        <div class="container-fluid">
                            <div class="row mt-4">
                                ...
                                <div class="row mt-3">
                                    <div class="col-10">
                                        <td><input placeholder="Username" type="email" class="form-control rounded-pill"
                                                name="username" required></td>
                                        <div class="mt-3">
                                            <td><input type="password" placeholder="Password"
                                                    class="form-control rounded-pill" name="password" required></td>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4">
                            ...
                            <div class="text-center">
                                <p class="small text-muted fz-13 mt-3">Sudah mempunyai akun? <a href="register.php"
                                        class="link-secondary"> Daftar Sekarang</a></p>
                            </div>
                    </form>
                </div>
