                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr align="center">
                                                ...
                                                <td>
                                                    <a href="edit_pengiriman.php?id_pengiriman=<?php echo $data['id_pengiriman']; ?>" name="bupdate_pengiriman" class="btn btn-light mb-3"><i class="uil uil-edit-alt"></i></a>
                                                    <a href="hapus_pengiriman.php?id_pengiriman=<?php echo $data['id_pengiriman']; ?>" name="bhapus" class="btn btn-danger mb-3"><i class="uil uil-trash-alt"></i></a>
